...
public class exerciseHistoryControl {
    ...
    private void clickRow() {
        ...
        if (exerciseTable.getSelectionModel().getSelectedItem() != null) {
            ...
            setRepStringAndSet();
            sceneNavigation.getInstance().showPreviousSetPage();
        }
    }
    ...
    private void setRepStringAndSet(){
        currentDateTime = dateChoiceControl.getSetDateTime();
        try{
...
class GetAllPastExercisesTask extends Task {
    ...
    public ObservableList<bbExercise> call() {
        ...
        return FXCollections.observableArrayList(bbDatabase.getInstance().listAllExercisesByDate(dateChoiceControl.getSetDateTime()));
    }
}
